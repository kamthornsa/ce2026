    ...
    const fetchFaculty = async () => {
      try {
        ...
        if (response.ok) {
          ...
          setPreviewUrl(data.media_assets?.file_path || null);
        } else {
  ...
  return (
    <div>
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-1">Update faculty member profile</p>
      </div>
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <div className="space-y-4">
                ...
                {previewUrl ? (
                  ...
                  <div className="w-full aspect-square rounded-lg border-2 border-dashed border-gray-300 flex items-center justify-center bg-gray-50 p-4 text-center text-sm text-gray-500">
                    Image is linked but no preview is available yet.
                  </div>
                ) : (
